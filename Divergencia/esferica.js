    ...
    let elementoResultado=document.getElementById("resultado")
        e.preventDefault();
            ...
            document.getElementById("error4").style.display="none";
                    ...
                    let cadena1=refactorirString(entrada1,"*x^2");
                    let cadena2=refactorirString(entrada2,"*sin(y)");
                    ...
                    console.log(derivada3)
                      ...
                      derivada1=refactorirString(derivada1,"*(1/x^2)");
                      derivada2=refactorirString(derivada2,"*(1/x*sin(y))");
                      derivada3=refactorirString(derivada3,"*(1/x*sin(y))");
